...
const MANUAL_REVIEW_FIELDS: Record<string, string[]> = {
  ...
  expenses: ["vendor", "invoice_number", "date", "amount", "category", "classification", "description", "property_name", "building_name", "unit_number", "tenant_name"],
  invoices: ["vendor", "invoice_number", "date", "amount", "category", "description", "property_name", "building_name", "unit_number", "tenant_name"],
