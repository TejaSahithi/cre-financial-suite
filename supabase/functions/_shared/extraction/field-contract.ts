...
export const LEASE_FIELD_CONTRACT: FieldContractEntry[] = [
  ...
  // ── property_premises ──────────────────────────────────────────────────
  { canonicalKey: "property_address", aliases: ["premises_address", "premises_location"], group: "property_premises", requiredForApproval: true, requiredForCam: false, requiredForBudget: false, requiredByDocumentProfile: ["full_lease", "amendment"], evidenceRequired: true, inLeaseSchema: true, alternateFieldKeys: ["property_name"] },
  ...
  { canonicalKey: "unit_number", aliases: ["unit", "suite", "suite_number", "space"], group: "property_premises", requiredForApproval: false, requiredForCam: false, requiredForBudget: false, requiredByDocumentProfile: [], evidenceRequired: true, inLeaseSchema: true },
  { canonicalKey: "floor", aliases: ["floor_number", "level"], group: "property_premises", requiredForApproval: false, requiredForCam: false, requiredForBudget: false, requiredByDocumentProfile: [], evidenceRequired: true, inLeaseSchema: true },
  ...
  { canonicalKey: "permitted_use", aliases: ["premises_use", "use_clause"], group: "property_premises", requiredForApproval: false, requiredForCam: false, requiredForBudget: false, requiredByDocumentProfile: [], evidenceRequired: true, inLeaseSchema: true },
  ...
  { canonicalKey: "lease_term_months", aliases: ["lease_term", "initial_term", "term_months"], group: "term_dates", requiredForApproval: false, requiredForCam: false, requiredForBudget: false, requiredByDocumentProfile: [], evidenceRequired: false, inLeaseSchema: true },
  ...
  { canonicalKey: "assignment_provisions", aliases: ["assignment_rights"], group: "legal_options", requiredForApproval: false, requiredForCam: false, requiredForBudget: false, requiredByDocumentProfile: [], evidenceRequired: true, inLeaseSchema: true },
