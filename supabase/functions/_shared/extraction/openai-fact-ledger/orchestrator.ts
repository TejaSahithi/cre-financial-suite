...
function withOpenAIFactLedgerDebug<T extends ExtractionPipelineResult>(result: T): T {
  ...
  if (debug && typeof debug === "object") {
    ...
    if (debug.extraction_contract_version === "vertex-fact-ledger-v1") {
      debug.legacy_extraction_contract_version = "vertex-fact-ledger-v1";
      debug.extraction_contract_version = "openai-fact-ledger-v1";
    }
  }
  return result;
}
  ...
  try {
    ...
    return withOpenAIFactLedgerDebug({
      ...
      metadata: {
        ...
        extractionDebug: {
          extraction_contract_version: "openai-fact-ledger-v1",
