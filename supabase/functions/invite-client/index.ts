 ...
 *   { email: string, full_name?: string, role: string, org_id: string }
 *
 * The calling user must have a valid JWT and be org_admin or super_admin.
 * Returns: { success: true, user_id: string } | { error: string }
 */
