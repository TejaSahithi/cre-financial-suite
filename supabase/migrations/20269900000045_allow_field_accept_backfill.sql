-- Allow reviewer Accept to backfill missing canonical field values.
...
BEGIN
  ...
  END IF;
  IF p_field_area = 'field_value' AND p_action NOT IN ('field_evidence_edit', 'field_accept_backfill', 'custom_field_added') THEN
