...
async function testOCR() {
  ...
  if (data.method === 'gemini_vision_ocr' || data.method === 'gemini_vision_fields') {
    console.log('SUCCESS: Gemini Vision OCR was used as fallback.');
  } else {
    console.log('FAILURE: Gemini Vision OCR was NOT used. Extraction method:', data.method);
  }
}
