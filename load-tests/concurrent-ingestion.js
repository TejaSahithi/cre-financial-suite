...
export const options = {
  scenarios: {
    steady: { executor: "constant-vus", vus: 10, duration: "1m" },
  },
  thresholds: {
...
export default function () {
  const res = http.post(`${BASE_URL}/lease-extraction-worker`, JSON.stringify({ uploaded_file_id: __ENV.UPLOADED_FILE_ID || "load-file", organization_id: ORGANIZATION_ID, stale_generation_guard: true }), { headers, tags: { organization: ORGANIZATION_ID, stale: "false" } });
