...
function fieldCuePattern(fieldKey) {
  const cues = {
    ...
    commencement_date: /\b(?:commencement|commence|start|term|effective|beginning|begins|from|dated|as\s+of)\b/i,
    start_date: /\b(?:commencement|commence|start|term|effective|beginning|begins|from|dated|as\s+of)\b/i,
    expiration_date: /\b(?:expiration|expire|expiry|end|ending|ends|through|thru|until|to|term)\b/i,
    end_date: /\b(?:expiration|expire|expiry|end|ending|ends|through|thru|until|to|term)\b/i,
    rent_commencement_date: /\b(?:rent\s+commencement|rent\s+start|rent\s+begins|rent|commencement|effective|from)\b/i,
    lease_date: /\b(?:lease\s+date|date|effective\s+date|effective|made|entered|executed|dated|as\s+of)\b/i,
