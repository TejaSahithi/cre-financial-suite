...
const STATUS_CONFIG = {
  ...
  pdf_parsed: { color: "bg-purple-100 text-purple-700", icon: Loader2, spin: true },
  ...
  review_required: { color: "bg-amber-100 text-amber-700", icon: CheckCircle },
  approved: { color: "bg-blue-100 text-blue-700", icon: Loader2, spin: true },
  ...
  computing: { color: "bg-purple-100 text-purple-700", icon: Loader2, spin: true },
