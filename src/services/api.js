...
const ALLOWED_COLUMNS = {
  ...
  ExpenseClassification: new Set([
    ...
    'rule_set_id', 'recovery_rule_id', 'linked_expense_rule_id', 'recovery_status',
    'recoverability_result', 'cam_pool_id', 'recovery_reason', 'cam_eligible',
    'recovery_method', 'allocation_method', 'allocation_basis',
    ...
    'approval_status', 'notes', 'classified_by', 'classified_at', 'approved_by', 'approved_at',
    ...
    'sent_to_cam', 'sent_to_cam_at', 'sent_to_cam_by', 'cam_status', 'next_step',
  ]),
