...
const COMPATIBILITY_MISSING_COLUMNS = {
  Lease: new Set([
    ...
    // Extended fields (from 20260408_lease_extended_fields.sql and similar)
    'renewal_notice_days',
...
const ALLOWED_COLUMNS = {
  ...
  Lease: new Set([
    ...
    'lease_date', 'property_name', 'property_address', 'landlord_address',
    'tenant_contact_name', 'tenant_address', 'suite_number', 'rentable_area_sqft',
    'permitted_use', 'broker_name', 'lease_term', 'commencement_date', 'expiration_date',
    'renewal_notice_days', 'renewal_escalation_percent', 'holdover_rent_multiplier',
    'base_rent_monthly', 'rent_due_day', 'rent_frequency', 'rent_payment_timing',
    'late_fee_grace_days', 'late_fee_percent', 'default_interest_rate_formula',
    'building_rsf', 'tenant_rsf', 'tenant_pro_rata_share', 'floor_plan_reference',
    'parking_rights', 'common_area_description',
  ...
  Expense: new Set([
    ...
    'category', 'expense_category_id', 'expense_subcategory', 'amount', 'classification', 'vendor', 'vendor_name',
    'vendor_id', 'gl_code', 'fiscal_year', 'month', 'date', 'source',
    'expense_date', 'billing_period_start', 'billing_period_end',
    'source_type', 'recovery_status', 'recovery_rule_id', 'linked_expense_rule_id',
    'recoverability_result', 'cam_pool_id', 'recovery_reason', 'cam_eligible',
    'recovery_method', 'rule_source',
    'confidence_score', 'evidence_text', 'evidence_page_number',
    'approval_status', 'review_status', 'approved_by', 'approved_at', 'notes',
  ...
  ExpenseClassification: new Set([
    ...
    'rule_set_id', 'recovery_rule_id', 'recovery_status',
    'recoverability_result', 'recovery_reason', 'cam_eligible',
    'recovery_method', 'allocation_method',
    ...
    'approval_status', 'notes', 'classified_at', 'approved_by', 'approved_at',
    'classification_key', 'actual_expense_id', 'lease_expense_rule_id',
    'category', 'subcategory', 'amount', 'service_period_start', 'service_period_end',
    'classification_status', 'exception_type', 'reviewed_by', 'reviewed_at', 'finalized_at',
