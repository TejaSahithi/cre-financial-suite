...
const ROLE_PAGES = {
  org_admin: [
    ...
    "Expenses", "AddExpense", "BulkImport", "ExpenseProjection", "LeaseExpenseClassification", "ExpenseReview",
  ...
  viewer: [
    ...
    "Tenants", "TenantDetail",
    "Leases", "LeaseReview",
    "Expenses", "Billing", "ExpenseProjection", "LeaseExpenseClassification", "ExpenseReview",
    "BudgetDashboard",
  ...
  auditor: [
    "Dashboard", "PortfolioInsights",
    "AuditLog",
    "Expenses", "Billing", "ChartOfAccounts", "ExpenseProjection", "LeaseExpenseClassification", "ExpenseReview",
