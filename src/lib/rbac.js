...
const ROLE_PAGES = {
  org_admin: [
    ...
    "Leases", "LeaseDetail", "LeaseUpload", "LeaseReview", "RentProjection", "CriticalDates",
    "Expenses", "AddExpense", "BulkImport", "LeaseExpenseRules", "ExpenseProjection", "LeaseExpenseClassification", "ExpenseReview",
    "CAMDashboard", "CAMSetup", "CAMCalculation",
    "Billing", "Revenue",
  ...
  editor: [
    ...
    "Leases", "LeaseDetail", "LeaseUpload", "LeaseReview", "CriticalDates",
    "Expenses", "AddExpense", "BulkImport", "LeaseExpenseRules", "ExpenseProjection", "LeaseExpenseClassification", "ExpenseReview",
    "BudgetDashboard", "CreateBudget", "BudgetReview",
  ...
  viewer: [
    ...
    "Properties", "Buildings", "Units", "BuildingsUnits", "PropertyDetail",
    "Tenants", "TenantDetail",
    "Leases", "LeaseDetail", "LeaseReview", "CriticalDates",
