...
const ROLE_PAGES = {
  org_admin: [
    ...
    "Expenses", "AddExpense", "BulkImport", "ExpenseProjection", "LeaseExpenseClassification",
  ...
  manager: [
    ...
    "Tenants", "TenantDetail", "Vendors", "VendorProfile",
    "Leases", "LeaseUpload", "LeaseReview", "RentProjection",
    "Expenses", "AddExpense", "BulkImport", "LeaseExpenseClassification",
    "CAMDashboard", "CAMCalculation",
    "Billing",
    "BudgetDashboard", "CreateBudget", "BudgetReview",
  ...
  viewer: [
    ...
    "Tenants", "TenantDetail",
    "Leases", "LeaseReview",
    "Expenses", "Billing", "LeaseExpenseClassification",
    "BudgetDashboard",
  ...
  auditor: [
    "Dashboard", "PortfolioInsights",
    "AuditLog",
    "Expenses", "Billing", "ChartOfAccounts", "LeaseExpenseClassification",
